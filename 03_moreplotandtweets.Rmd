...
```{r, include=False,execute=False,echo=FALSE}
...
Exploring tweets from the 2018 conference of the Cultural Evolution Society :

```{r}

ces2018 <- searchTwitter("#CESConf2018", n=1500)
```
